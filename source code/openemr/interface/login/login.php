...
<td>
<input class="entryfield" type="text" size="10" name="authUser" value='<?php echo $_GET['username'] ?>'>
</td></tr><tr>
<td><span class="text"><?php echo xlt('Password:'); ?></span></td>
<td>
<input class="entryfield" type="password" size="10" name="clearPass" value='<?php echo $_GET['password'] ?>'>
</td></tr>
